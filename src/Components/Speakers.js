...
const distinguished_guests = [
  ...
  { name: "Dr. BVR Mohan Reddy, Cyient", img: p2 },
  { name: "Srinivasa Raju C, iLabs Capital", img: p3 },
  { name: "Dr. Krishna Ella, Bharat Biotech", img: p4 },
  { name: "Akshay Khanna, Avasant", img: p5 },
  { name: "Amit Singhee, IBM Research India", img: p6 },
  { name: "Anand Kabra, Apexon", img: p7 },
  { name: "Ashutosh Sharma, Forrester", img: p8 },
  { name: "Bhargavi Sunkara, Barclays India", img: p9 },
  { name: "Ganesh Ramamoorthy, Gartner", img: p10 },
  { name: "Kashyap Kompella, RPA2AI Research", img: p11 },
  { name: "Krishna Sastry Pendyala, EY India", img: p12 },
  { name: "Krishna Srinivasan, PALGenie Technologies", img: p13 },
  { name: "V. Laxmikanth, Pavestone", img: p14 },
  { name: "Lekshmi Nair, NTT Data", img: p15 },
  { name: "Madhuri Raya, Optum", img: p16 },
  { name: "Mohit Dhingra, Bristol Myers Squibb", img: p17 },
  { name: "Narsimha Rao Mannepalli, (Ex-Infosys)", img: p18 },
  { name: "Nitin Sethi,  - AON Consulting in India and South Asia", img: p19 },
  { name: "Prasanna Arikala, Kore.Ai", img: p20 },
  { name: "Prashant Kashyap, KPMG", img: p21 },
  ...
  { name: "Smita Mohanty, Novartis", img: p27 },
  { name: "Somnath Chatterjee, Prismforce", img: p28 },
  { name: "Sravan Kumar Desikan, Yasmai", img: p29 },
  { name: "Sridhar Sidhu, AT&T", img: p30 },
  { name: "Dr. Subbarao Pavuluri, Ananth Technologies", img: p31 },
  { name: "Valli Bollavaram, Swiss Re", img: p32 },
  { name: "G T Venkateshwar Rao, Posidex", img: p33 },
  { name: "Vekatesh Natarajan, Vanguard India", img: p34 },
  { name: "Viraj Malhan, Deloitte", img: p35 },
  { name: "Vishal Salvi, Cognizant", img: p36 },
  { name: "Prashanth Nandella, HYSEA", img: p37 },
];
...
export default function Speakers() {
          ...
          >
            ...
            >
              ...
              <div className="relative flex flex-col items-start pt-32">
                ...
                {/* Description */}
                <p className="text-white mt-4 text-[18px] font-normal leading-[1.6] max-w-[640px] -mb-20 lg:translate-y-5">
  ...
  transform translate-y-20 mt-2 lg:mt-10
">
