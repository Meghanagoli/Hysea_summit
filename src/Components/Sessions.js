            ...
            >
              ...
              <div className="relative flex flex-col items-start pt-32">
                ...
                <div className="absolute top-0 left-0 flex flex-col items-start">
                  ...
                  />
                  <span
                    className="uppercase text-white mt-[0.2rem] pl-[4.7rem] -ml-3 lg:mt-2 lg:-ml-3.5 lg:mt-3 "
                    style={{
...
lg:bg-[position:left_center]"
          ...
          >
            <div className="relative flex flex-col items-start mt-24 pt-32 sm:pt-36">
              ...
              <div className="absolute top-0 left-0 flex flex-col items-start">
                ...
                <span
                  className="uppercase text-white mt-[0.6rem] pl-[3.3rem] ml-0 md:ml-4 "
                  style={{
                    fontFamily: '"SF Pro Text", "SF Pro", "Segoe UI", system-ui, -apple-system, sans-serif',
                    fontSize: "16px",
                    fontStyle: "normal",
      ...
      {/* Sessions content blocks (unchanged) */}
      <section
        className="
          relative w-full
          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-[1fr_1.2fr] items-center gap-12">
            <div className="flex justify-center lg:justify-end relative z-10 lg:pr-0">
              <div className=" w-full lg:pl-24">
                <div className="bg-white/50 rounded-xl shadow-[0_4px_65px_8px_rgba(0,0,0,0.1)] backdrop-blur-[54px] p-8 sm:p-10 lg:p-12 lg:-mr-20">
            ...
            <div className="flex justify-center lg:justify-start relative z-10">
              <div className=" w-full lg:pr-24">
                ...
                >
                  ...
                  <p className="text-black/70 text-base leading-relaxed mt-5">
                    The master classes will be conducted during morning and afternoon in parallel to the conference sessions.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-center lg:justify-end relative z-10 lg:pr-0">
              <div className=" w-full lg:pl-24">
                ...
                >
                  ...
                  <p className="text-black/70 text-base leading-relaxed mt-5">
                    The awards ceremony will take place in the evening after conclusion of conference sessions and master classes.
                  </p>
                </div>
              </div>
            </div>
