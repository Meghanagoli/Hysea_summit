            ...
            <div aria-hidden={true}>
              ...
              <div className="pb-3 sm:pb-4">
                <p className="text-[#0530A8] font-light italic text-[14px] sm:text-[15px] md:text-[16px]">
                  Early bird offer ends Jan 20th, 2026
                </p>
              </div>
              ...
              <p className="text-[#0530A8] font-light italic mb-2 text-[14px] sm:text-[15px] md:text-[16px]">
                Sale ends Feb 13th, 2026
              </p>

             
              <div className="border-b border-gray-200 pb-5 mb-5">
                <div className="flex items-baseline justify-between gap-3 sm:gap-4">
                  <h3 className="text-[#14328D] text-[18px] sm:text-[20px] md:text-[22px] lg:text-[26px] font-semibold">
                    Delegate Bulk Booking:
                  </h3>
                  <div className="text-black text-[18px] sm:text-[20px] md:text-[22px] lg:text-[24px] font-bold">
                    ₹4,499
                  </div>
                </div>
                <p className="mt-3 text-[14px] sm:text-[15px] md:text-[16px] font-normal text-black">
                  Minimum group size is 5 tickets.
                </p>
              </div>
...
{/*           
              ...
              <div className="border-b border-gray-200 pb-5 mb-5">
                ...
                <p className="mt-3 text-[14px] sm:text-[15px] md:text-[16px] font-normal text-black leading-relaxed">
                  This ticket gives access to HYSEA Masterclass series. Classes offer deep-dive
                  learning, hands-on practice, and expert-guided sessions on the following topics
                  designed to strengthen real world skills in AI, LLMs, Agents and RAGs:
                </p>

                <ul className="mt-4 list-disc pl-6 text-[14px] sm:text-[15px] md:text-[16px] text-black space-y-2">
                  <li>1 for 3 paid registrations</li>
                  <li>2 for 5 paid registrations</li>
                  <li>3 for 7 paid registrations</li>
                  <li>4 for 10 paid registrations</li>
                </ul>

                <p className="mt-4 font-light italic text-gray-600 text-[13px] sm:text-[14px]">
                  <em>
                    note: Participants may attend 1 morning + 1 afternoon session (lunch included).
                    All sessions include a certificate, MC Kit, and group photographs. Day 1
                    Masterclasses – 2.
                  </em>
                </p> */}
...
className="mt-6 inline-flex items-center rounded-md bg-[#1E60D9] px-4 md:px-5 py-2 text-white text-[14px] sm:text-[15px] md:text-[16px] font-semibold hover:bg-[#154abd] transition">
  Register Now
          ...
          <div className="order-2 lg:order-2">
              <div className="border-2 border-[#0530A8] overflow-hidden w-full sm:w-[420px] md:w-[450px] h-[300px] sm:h-[380px] md:h-[420px] ml-auto lg:max-w-none bg-gray-50">
              <iframe
