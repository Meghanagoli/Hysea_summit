    ...
    <section id="register" className="bg-white">
      <div className="mx-auto max-w-9xl px-4 sm:px-6 md:px-12 py-16 md:py-28">
        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-start px-2">
          ...
          <div className="order-2 lg:order-2 -mt-6 md:-mt-12">
            <div className="border-2 border-[#0530A8] overflow-hidden w-full sm:w-[420px] md:w-[450px] h-[200px] sm:h-[280px] md:h-[320px] ml-auto lg:max-w-none bg-gray-50">
              <iframe
