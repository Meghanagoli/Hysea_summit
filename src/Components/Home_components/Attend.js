...
const Attend = () => {
  return (
    <section
      className="w-full max-w-9xl px-4 md:px-6 py-16 lg:py-32 bg-cover bg-center bg-no-repeat"
    ...
    >
      <div className="max-w-[1100px] mx-auto text-center px-6 text-white">
        ...
        <p className="text-sm md:text-[17px] leading-relaxed max-w-[900px] mx-auto opacity-95">
          Be part of the HYSEA Annual Summit, where Intelligence Everywhere
          shapes the future. The Summit attracts a broad cross-section of the
          technology ecosystem, enabling multi-faceted networking. Build and
          diversify your network by engaging with forward-thinking senior IT
