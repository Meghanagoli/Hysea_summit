            ...
            <div className="relative z-10 lg:pt-[144px] lg:pb-[144px] lg:px-[80px] lg:pr-[200px]">
              ...
              <div className="relative flex flex-col items-start pt-32">
                ...
                <div className="absolute top-0 left-0 flex flex-col items-start">
                  ...
                  />
                  <span
                    className="uppercase text-white mt-[0.2rem] pl-[4.7rem] -ml-3.5 translate-y-3 lg:-ml-3.5"
                    style={{
                ...
                {/* 33rd Edition */}
                <div className="inline-flex items-center gap-2 rounded-[30px] bg-[#FFBB00] px-4 py-[6px] mb-4 -mt-9 lg:translate-y-3">
                ...
                <p className="text-white mt-5 text-[17px] font-normal leading-[1.6] max-w-[640px] mb-6 lg:translate-y-4">
          ...
          <div className="relative z-10 -mt-[100px] px-5 pt-8 pb-12 sm:-mt-[50px]">
            ...
            <div className="relative flex flex-col items-start mt-10 pt-32 sm:pt-36">
              ...
              <div className="absolute top-0 left-0 flex flex-col items-start">
                ...
                <span
                  className="uppercase text-white mt-[0.2rem] pl-[3.3rem] translate-y-2 md:ml-4"
                  style={{
                    fontFamily: '"SF Pro Text", "SF Pro", "Segoe UI", system-ui, -apple-system, sans-serif',
                    fontSize: "16px",
                    fontStyle: "normal",
