              ...
              "
                        >
                            <div className="relative flex flex-col items-start pt-32">
                                ...
                                <p className="text-white mt-5 text-[18px] font-normal leading-[1.6] max-w-[640px] lg:translate-y-4">
            ...
            "
                    >
                        <div className="relative flex flex-col items-start mt-10 pt-32 sm:pt-36">
                            ...
                            {/* 33rd Edition */}
                            <div className="inline-flex items-center gap-2 rounded-[30px] bg-[#FFBB00] px-4 py-[6px] mb-4 -mt-19 sm:-mt-10 -mt-10">
                                <h3 className="text-[#0A2A73] text-sm font-semibold">
                                    33rd Edition | March 5, 2026 | Hyderabad
                                </h3>
                            </div>
